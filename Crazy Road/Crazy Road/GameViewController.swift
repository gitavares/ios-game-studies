...
class GameViewController: UIViewController {
    ...
    var jumpFowardAction: SCNAction?
    ...
    func setupActions(){
        ...
        jumpFowardAction = SCNAction.group([turnFowardAction, jumpAction, moveFowardAction])
    ...
    func jumpFoward(){
        if let action = jumpFowardAction {
            addLanes()
